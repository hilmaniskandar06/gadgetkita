      ...
      <div className="max-w-2xl mx-auto px-5 py-14 flex flex-col items-center">
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          {(() => {
            ...
            if (!wa) return null
            return (
              <a href={wa} target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-gold-500 hover:text-cacao-900 transition-colors">
                <WhatsappIcon />
              </a>
            )
          })()}
