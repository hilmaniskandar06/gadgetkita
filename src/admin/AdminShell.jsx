...
import { LogOut, Store, Package, Tag, Bookmark, Palette, FileText, Ticket, CreditCard, ShoppingBag, Users, Bell, MessageCircle, FileDown, LayoutTemplate } from 'lucide-react'
...
export default function AdminShell({ title, actions, children }) {
  ...
  const menu = [
    ...
    { name: 'Brand / Merk', path: '/admin/brand', icon: Bookmark },
    { name: 'Warna Produk', path: '/admin/warna', icon: Palette },
